...
export function RoomDetail() {
  ...
  const { devices, rooms, isDarkMode } = useApp();
  ...
  // Get devices and modules in this room
        ...
        <>
          ...
          <div className="space-y-6">
            {roomDevices.map((device) => {
              const deviceModules = device.modules || [];
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 text-sm mt-1">
                            ...
                            <span className={isDarkMode ? "text-gray-400" : "text-gray-600"}>
                              {deviceModules.length} modules
                            </span>
                          </div>
                        </div>
                      </div>
                      <Link
                        to={`/device-management/${device.id}`}
                  ...
                  <div className="p-5">
                    {deviceModules.length === 0 ? (
                      <div className={`text-center py-8 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                        ...
                        <p className="text-sm">No modules configured for this device</p>
                        <Link
                          to={`/device-management/${device.id}`}
