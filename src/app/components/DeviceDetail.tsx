...
import { MODULE_IDS } from "../config/moduleConstants";

// Hardcoded modules from backend
const MOCK_DEVICE_MODULES: ModuleDTO[] = [
  {
    id: MODULE_IDS.LIGHT_SENSOR,
  ...
  },
  {
    ...
    type: "FAN",
    state: "0",
    deviceChannelId: "2f4eb7a5-ab7a-4678-be60-c4808feb43f7",
    status: "ONLINE",
    createdAt: new Date().toISOString(),
  },
  {
    id: MODULE_IDS.LED_RGB,
    name: "LED RGB",
    type: "LED",
    state: "0",
    deviceChannelId: "718a8ac9-dd7e-42d1-9b55-98f66085270c",
    status: "ONLINE",
    createdAt: new Date().toISOString(),
  },
  {
    id: MODULE_IDS.LCD_DISPLAY,
    name: "Màn hình LCD 16x02",
    type: "LCD",
    state: "0",
    deviceChannelId: "a3ad496a-b553-4ce5-9dcf-7c775aa7e0a7",
    status: "ONLINE",
    createdAt: new Date().toISOString(),
  },
];
